---
title: "SynMut: Tools for Designing Synonymous Mutants for DNA Sequences"
author: "Haogao Gu"
date: "`r Sys.Date()`"
output: 
...
```{r, echo=FALSE}
url <- "https://raw.githubusercontent.com/Koohoko/SynMut/master/docs/component.png"
```
...
### Installation
```{r}
if(!library(SynMut, logical.return = TRUE)){
...
### Generating synonymous sequences mimicking a specific codon usage pattern {#codon_mimic}
