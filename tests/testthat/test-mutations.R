...
test_that("dinu_to", {
  ...
  expect_silent(get_du(dinu_to(rgd.seq, max.dinu = "cg", keep = TRUE)))
  expect_silent(get_du(dinu_to(rgd.seq, min.dinu = "tg", keep = TRUE)))
  expect_silent(get_cu(dinu_to(rgd.seq.single, max.dinu = "cg", keep = TRUE)))
  expect_silent(get_du(dinu_to(rgd.seq.single, min.dinu = "tg", keep = TRUE)))
  expect_silent(get_cu(dinu_to(rgd.seq.no.region, max.dinu = "cg", keep = TRUE)))
  expect_silent(get_du(dinu_to(rgd.seq.no.region, min.dinu = "tg", keep = TRUE)))
})
